...
local ARQUIVOS = {}
local ORDEM = { "pgapi.lua", "ui.lua", "config.lua", "pixel.lua", "palette.lua", "rendimento.lua", "clima.lua", "circuito.lua", "boot.lua", "pgmon.lua", "suntrack.lua", "painel.lua", "configurar.lua", "diagnostico_medidor.lua", "soldemo.lua", "startup.lua" }
ARQUIVOS["pgapi.lua"] = [=[
...
ARQUIVOS["diagnostico_medidor.lua"] = [=[
